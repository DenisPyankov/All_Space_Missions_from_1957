...
В рамках исследования были последовательно решены четыре задачи:

1. **Подготовка данных и EDA** – очистка, агрегация, визуализация, анализ тренда, сезонности и автокорреляционной структуры.
2. **Статистические методы прогнозирования** – сравнение наивных моделей, ручной SARIMA, AutoARIMA, AutoETS, AutoTheta и Prophet с бектестингом и анализом остатков.
3. **Data‑driven методы (ML и DL)** – построение моделей на основе лаговых признаков (LinearRegression, RandomForest, XGBoost) и нейросетевых архитектур (LSTM, NBEATS, NHITS), сравнение с классическими подходами.
4. **Итоговый пайплайн** – реализация воспроизводимого процесса прогнозирования, включающего AutoARIMA, XGBoost и LSTM; статистическое тестирование различий в точности (тест Диеболда–Мариано) и замер производительности.
